...
void ModelNode::loadModel(string const& path) {
...
Mesh ModelNode::processMesh(aiMesh* mesh, const aiScene* scene) {
    // data to fill
...
vector<Texture> ModelNode::loadMaterialTextures(aiMaterial* mat, aiTextureType type, string typeName) {
    vector<Texture> textures;
